...
// unordered map wiil store data in the random
// T.C. = O(1)   in unordered map in insertion, search, erase, find operation

    // declearation of unordered map
    unordered_map<string, int> m ;    // unordered_map<key, value> name ;


// --------------------------------------------  Different Operations & Functions in map  --------------------------------------------------------- 


// (1) Insertion in unordered_map
    // way -1
...
// (2) Search key in unordered_map
    ...
    // When we search a key that is not present in unordered_map
    cout<<m["unkonownkey"] << endl ;
    cout<<m.at("unkonownkey") << endl ;

    
// (3) Size of unordered_map
    cout<< m.size() << endl ;
...
// (5) Erase any key form unordered_map
    m.erase("Mohit") ;
    cout<< m.size() << endl ; 
...
// (8) Traversing a map
    ...
    // unordered_map<string, int> :: iterator it; -> decleration of iterator
    // it = m.begin() ; -> initilization of iterator
    unordered_map<string, int> :: iterator it = m.begin() ;

    while(it != m.end()){  // T.C. = O(n)
